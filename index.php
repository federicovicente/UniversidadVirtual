      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="images/C-empresa.jpg" class="d-block w-100 imgOscura" alt="...">
          ...
          <div class="carousel-item">
            <img src="images/C-IA.jpg" class="d-block w-100 imgOscura" alt="...">
            <div class="carousel-caption d-none d-md-block">
          ...
          <div class="carousel-item">
            <img src="images/C-tecnologia.jpg" class="d-block w-100 imgOscura" alt="...">
            <div class="carousel-caption d-none d-md-block">
              <h5>Tecnologías</h5>
